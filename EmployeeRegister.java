...
public class EmployeeRegister extends JFrame {
	...
	public EmployeeRegister() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=EmployeeData.save(name, password, email, address, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(EmployeeRegister.this,"Account made successfully!");
				AdminLogat.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(EmployeeRegister.this,"Sorry, registration failed!");
			}
			}
		});
